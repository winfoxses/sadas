<div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($hits_products->isNotEmpty()): ?>
        <section class="featured-products">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $hits_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-3" wire:key="<?php echo e($product->id); ?>">
    ...
    <!--[if BLOCK]><![endif]--><?php if($new_products->isNotEmpty()): ?>
        <section class="new-products">
            <div class="container">
                ...
                <div class="owl-carousel owl-theme owl-carousel-full" wire:ignore>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $new_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    <?php
        ...
        \Livewire\store($this)->push('scripts', $__output, $__scriptKey)
    ?>
<?php /**PATH D:\Server6\OSPanel\home\laravel-eshop.loc\resources\views/livewire/home-component.blade.php ENDPATH**/ ?>